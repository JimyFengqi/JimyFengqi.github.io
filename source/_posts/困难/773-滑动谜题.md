...
## 中文题目
<div><p>在一个 2 x 3 的板上（<code>board</code>）有 5 块砖瓦，用数字 <code>1~5</code> 来表示, 以及一块空缺用&nbsp;<code>0</code>&nbsp;来表示.</p>
...
![](../images/sliding-puzzle-0.png){:width=450}{:align=center}

拼图中有一个格子是空的，可以利用这个空着的格子移动其他数字。你需要通过移动这些数字，得到某个特定排列顺序，这样就算赢了。

我小时候还玩过一款叫做「华容道」的益智游戏，也和滑动拼图比较类似：

![](../images/sliding-puzzle-1.png){:width=450}{:align=center}
...
![](../images/sliding-puzzle-2.png){:width=450}{:align=center}
...
![](../images/sliding-puzzle-3.png){:width=450}{:align=center}
...
![](../images/sliding-puzzle-4.png){:width=450}{:align=center}

至此，我们就把这个问题完全转化成标准的 BFS 问题了，借助前文 [BFS 算法框架](https://labuladong.gitbook.io/algo) 的代码框架，直接就可以套出解法代码了：
