---
title: 1356-根据数字二进制下 1 的数目排序(Sort Integers by The Number of 1 Bits)
categories:
  - 简单
tags:
  - 位运算
...
## 英文原文
<div><p>Given an integer array <code>arr</code>. You have to sort the integers in the array&nbsp;in ascending order by the number of <strong>1&#39;s</strong>&nbsp;in their binary representation and in case of two or more integers have the same number of <strong>1&#39;s</strong> you have to sort them in ascending order.</p>
...
## 中文题目
<div><p>给你一个整数数组&nbsp;<code>arr</code>&nbsp;。请你将数组中的元素按照其二进制表示中数字 <strong>1</strong> 的数目升序排序。</p>
...
![image.png](../images/sort-integers-by-the-number-of-1-bits-0.png){:width="350px"}{:align="left"} 
