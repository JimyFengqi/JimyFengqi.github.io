...
## 中文题目
<div><p>给你两棵二叉树的根节点 <code>p</code> 和 <code>q</code> ，编写一个函数来检验这两棵树是否相同。</p>
...
![BST](../images/same-tree-0.png){:width=450}{:align=center}
...
![notBST](../images/same-tree-1.png){:width=450}{:align=center}
...
图片来自 LeetCode
![1](../images/same-tree-2.png){:width=450}{:align=center}
...
图片来自 LeetCode
![2](../images/same-tree-3.png){:width=450}{:align=center}
...
图片来自 LeetCode
![2](../images/same-tree-4.png){:width=450}{:align=center}
