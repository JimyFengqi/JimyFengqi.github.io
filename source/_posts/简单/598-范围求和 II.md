---
title: 598-范围求和 II(Range Addition II)
date: 2021-12-03 22:41:38
categories:
  - 简单
tags:
  - 数组
...
> 原文链接: https://leetcode-cn.com/problems/range-addition-ii
...
## 中文题目
<div><p>给定一个初始元素全部为&nbsp;<strong>0</strong>，大小为 m*n 的矩阵&nbsp;<strong>M&nbsp;</strong>以及在&nbsp;<strong>M&nbsp;</strong>上的一系列更新操作。</p>
...
|                             题目                             | 难度 |
| :----------------------------------------------------------: | :---------: |
| [区间加法](https://leetcode-cn.com/problems/range-addition/) | 中等|
