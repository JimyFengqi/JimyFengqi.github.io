...
## 中文题目
<div><p>有一个密钥字符串 S ，只包含字母，数字以及 &#39;-&#39;（破折号）。其中， N 个 &#39;-&#39; 将字符串分成了 N+1 组。</p>
...
如下题目已整理成离线 PDF (普通/暗黑) 放到 [公主号](https://oscimg.oschina.net/oscnet/up-19688dc1af05cf8bdea43b2a863038ab9e5.png)，后台回复「PDF」即可下载 ~
