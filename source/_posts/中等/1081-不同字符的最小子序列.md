---
title: 1081-不同字符的最小子序列(Smallest Subsequence of Distinct Characters)
date: 2021-12-03 22:23:25
categories:
  - 中等
tags:
  - 栈
...
## 中文题目
<div><p>返回 <code>s</code> 字典序最小的子序列，该子序列包含 <code>s</code> 的所有不同字符，且只包含一次。</p>
...
![](../images/smallest-subsequence-of-distinct-characters-0.jpg)
...
![](../images/smallest-subsequence-of-distinct-characters-1.jpg)

（图 2）

由于没有左侧相邻元素，因此**没办法丢弃**。

![](../images/smallest-subsequence-of-distinct-characters-2.jpg)

（图 3）

由于 4 比左侧相邻的 1 大。如果选择丢弃左侧的 1，那么会使得剩下的数字更大（开头的数从 1 变成了 4）。因此我们仍然选择**不丢弃**。

![](../images/smallest-subsequence-of-distinct-characters-3.jpg)
...
![](../images/smallest-subsequence-of-distinct-characters-4.jpg)
（图 5）
...
![](../images/smallest-subsequence-of-distinct-characters-5.jpg)
（图 6）
...
![](../images/smallest-subsequence-of-distinct-characters-6.jpg)
（图 7）
