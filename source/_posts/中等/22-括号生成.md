...
## 中文题目
<div><p>数字 <code>n</code>&nbsp;代表生成括号的对数，请你设计一个函数，用于能够生成所有可能的并且 <strong>有效的 </strong>括号组合。</p>
...
![image.png](../images/generate-parentheses-0.png)
...
![LeetCode 第 22 题：“括号生出”题解配图.png](../images/generate-parentheses-1.png){:width=500}
{:align=center}
...
![image.png](../images/generate-parentheses-2.png){:width=500}
{:align=center}
