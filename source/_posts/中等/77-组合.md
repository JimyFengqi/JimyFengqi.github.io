...
## 中文题目
<div><p>给定两个整数 <code>n</code> 和 <code>k</code>，返回范围 <code>[1, n]</code> 中所有可能的 <code>k</code> 个数的组合。</p>
...
![image.png](../images/combinations-0.png)
...
![image.png](../images/combinations-1.png){:width="500px"}
...
![image.png](../images/combinations-2.png)
...
![image.png](../images/combinations-3.png){:width="500px"}
...
![image.png](../images/combinations-4.png){:width="600px"}


画一个表格更容易看出边界条件。

![image.png](../images/combinations-5.png){:width="500px"}
