...
## 中文题目
<div><p>给定一个数组 <code>prices</code> ，其中 <code>prices[i]</code> 是一支给定股票第 <code>i</code> 天的价格。</p>
...
![image.png](../images/best-time-to-buy-and-sell-stock-ii-0.png){:width=500}
...
![image.png](../images/best-time-to-buy-and-sell-stock-ii-1.png)

![image.png](../images/best-time-to-buy-and-sell-stock-ii-2.png)
...
![image.png](../images/best-time-to-buy-and-sell-stock-ii-3.png){:width=500}
...
![](../images/best-time-to-buy-and-sell-stock-ii-4.png){:width=560}
...
| [最佳买卖股票时机含冷冻期](https://leetcode-cn.com/problems/best-time-to-buy-and-sell-stock-with-cooldown/) | 中等|
| [买卖股票的最佳时机含手续费](https://leetcode-cn.com/problems/best-time-to-buy-and-sell-stock-with-transaction-fee/) | 中等|
